...
function getUserName($email)
{
    ...
    $std = "SELECT username from users where email='$email'";
...
function getUserID($email)
{
    ...
    $std = "SELECT user_id from users where email='$email'";
    $q = $conect->prepare($std);
    $q->execute();
...
//    $hash = password_hash($password, PASSWORD_DEFAULT);
    ...
    $insertion = ("INSERT INTO users (username,password,email) VALUES ('$username','$password','$email')");
