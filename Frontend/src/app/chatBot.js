...
const body = document.querySelectorAll("test");
let userMessage;
...
document.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    var chatbot = document.querySelectorAll("test");
...
const handleChat = () => {
  ...
  // welcomeMessageElement = chatbox.querySelector(".chat");
  // if (welcomeMessageElement && welcomeMessageElement.parentNode === chatbox) {
  //   chatbox.removeChild(welcomeMessageElement);
  ...
  if (
    ...
    welcomeMessageElement.parentNode === chatContainer
  ) {
